...
use Kcsl\GmoClient\com\gmo_pg\client\input\EntryTranDocomoInput;
use Kcsl\GmoClient\com\gmo_pg\client\input\ExecTranDocomoInput;
...
class EntryExecTranDocomoInput
{
     ...
     */
    private $entryTranDocomoInput;
    /* @var $entryTranInput EntryTranDocomoInput */

    /**
     * @var ExecTranDocomoInput ドコモケータイ払い実行入力パラメータ
     */
    private $execTranDocomoInput;
    /* @var $execTranInput ExecTranDocomoInput */
