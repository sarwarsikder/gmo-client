...
use Kcsl\GmoClient\com\gmo_pg\client\input\EntryTranPaypayInput;
use Kcsl\GmoClient\com\gmo_pg\client\input\ExecTranPaypayInput;
...
class EntryExecTranPaypayInput
{
     ...
     */
    private $entryTranPaypayInput;
    /* @var $entryTranInput EntryTranPaypayInput */

    /**
     * @var ExecTranPaypayInput PayPay実行入力パラメータ
     */
    private $execTranPaypayInput;
    /* @var $execTranInput ExecTranPaypayInput */
