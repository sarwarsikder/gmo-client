 ...
 */
class MerpayPrePaymentCheckInput extends BaseInput {
	...
	public function setInputValues($params) {
		...
		$this->setSubscriptionId($this->getStringValue($params, 'SubscriptionId', $this->getSubscriptionId()));
