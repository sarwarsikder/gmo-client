...
use Kcsl\GmoClient\com\gmo_pg\client\input\EntryTranAuContinuanceInput;
use Kcsl\GmoClient\com\gmo_pg\client\input\ExecTranAuContinuanceInput;
...
class EntryExecTranAuContinuanceInput
{
     ...
     */
    private $entryTranAuContinuanceInput;
    /* @var $entryTranInput EntryTranAuContinuanceInput */

    /**
     * @var ExecTranAuContinuanceInput auかんたん決済継続課金実行入力パラメータ
     */
    private $execTranAuContinuanceInput;
    /* @var $execTranInput ExecTranAuContinuanceInput */
