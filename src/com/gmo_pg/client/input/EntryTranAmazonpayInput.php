 ...
 */
class EntryTranAmazonpayInput extends BaseInput {
	...
	private $tax;
	/**
	 * @var string AmazonPay実装タイプ
	 */
	private $amazonpayType;
	/**
	 * @var string 決済タイプ
	 */
	private $paymentType;
	...
	public function setAmazonpayType($amazonpayType) {
		$this->amazonpayType = $amazonpayType;
	}
	/**
	 * 決済タイプ設定
	 *
	...
	public function setInputValues($params) {
		...
		$this->setAmazonpayType($this->getStringValue($params, 'AmazonpayType', $this->getAmazonpayType()));
	...
	public function toString() {
		...
		$str .='&';
		$str .= 'AmazonpayType=' . $this->encodeStr($this->getAmazonpayType());
		$str .='&';
