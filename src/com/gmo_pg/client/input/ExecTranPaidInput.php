 ...
 */
class ExecTranPaidInput extends BaseInput {
	...
	public function setInputValues($params) {
		...
		$this->setContents($this->getStringValue($params, 'Contents', $this->getContents()));
	...
	public function toString() {
		...
		$str .='&';
		$str .= 'Contents=' . $this->encodeStr($this->getContents());
