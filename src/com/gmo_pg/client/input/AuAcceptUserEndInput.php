...
/**
 * <b>auかんたん決済支払い（利用承諾）利用承諾終了　入力パラメータクラス</b>
 *
 ...
 */
class AuAcceptUserEndInput extends BaseInput {
	...
	public function setInputValues($params) {
		...
		$this->setAuAcceptCode($this->getStringValue($params, 'AuAcceptCode', $this->getAuAcceptCode()));
	...
	public function toString() {
		...
		$str .='&';
		$str .= 'AuAcceptCode=' . $this->encodeStr($this->getAuAcceptCode());
