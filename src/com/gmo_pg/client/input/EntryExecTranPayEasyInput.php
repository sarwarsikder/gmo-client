...
use Kcsl\GmoClient\com\gmo_pg\client\input\EntryTranPayEasyInput;
use Kcsl\GmoClient\com\gmo_pg\client\input\ExecTranPayEasyInput;
...
class EntryExecTranPayEasyInput
{
     ...
     */
    private $entryTranPayEasyInput;
    /* @var $entryTranInput EntryTranPayEasyInput */

    /**
     * @var ExecTranPayEasyInput PayEasy決済実行入力パラメータ
     */
    private $execTranPayEasyInput;
    /* @var $execTranInput ExecTranPayEasyInput */
