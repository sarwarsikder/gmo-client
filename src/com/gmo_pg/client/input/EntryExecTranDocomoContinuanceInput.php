...
class EntryExecTranDocomoContinuanceInput
{
     ...
     */
    private $entryTranDocomoContinuanceInput;
    /* @var $entryTranInput EntryTranDocomoContinuanceInput */

    /**
     * @var ExecTranDocomoContinuanceInput ドコモ継続決済実行入力パラメータ
     */
    private $execTranDocomoContinuanceInput;
    /* @var $execTranInput ExecTranDocomoContinuanceInput */
