...
use Kcsl\GmoClient\com\gmo_pg\client\input\EntryTranNetcashInput;
use Kcsl\GmoClient\com\gmo_pg\client\input\ExecTranNetcashInput;
...
class EntryExecTranNetcashInput
{
     ...
     */
    private $entryTranNetcashInput;
    /* @var $entryTranInput EntryTranNetcashInput */

    /**
     * @var ExecTranNetcashInput NET CASH実行入力パラメータ
     */
    private $execTranNetcashInput;
    /* @var $execTranInput ExecTranNetcashInput */
