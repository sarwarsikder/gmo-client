...
use Kcsl\GmoClient\com\gmo_pg\client\input\EntryTranSbContinuanceInput;
use Kcsl\GmoClient\com\gmo_pg\client\input\ExecTranSbContinuanceInput;
...
class EntryExecTranSbContinuanceInput
{
     ...
     */
    private $entryTranSbContinuanceInput;
    /* @var $entryTranInput EntryTranSbContinuanceInput */

    /**
     * @var ExecTranSbContinuanceInput ソフトバンク継続実行入力パラメータ
     */
    private $execTranSbContinuanceInput;
    /* @var $execTranInput ExecTranSbContinuanceInput */
