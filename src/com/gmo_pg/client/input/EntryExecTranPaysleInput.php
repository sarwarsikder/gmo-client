...
use Kcsl\GmoClient\com\gmo_pg\client\input\EntryTranPaysleInput;
use Kcsl\GmoClient\com\gmo_pg\client\input\ExecTranPaysleInput;
...
class EntryExecTranPaysleInput
{
     ...
     */
    private $entryTranPaysleInput;
    /* @var $entryTranInput EntryTranPaysleInput */

    /**
     * @var ExecTranPaysleInput Paysle実行入力パラメータ
     */
    private $execTranPaysleInput;
    /* @var $execTranInput ExecTranPaysleInput */
