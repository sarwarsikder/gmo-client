...
use Kcsl\GmoClient\com\gmo_pg\client\input\EntryTranDocomoMiniInput;
use Kcsl\GmoClient\com\gmo_pg\client\input\ExecTranDocomoMiniInput;
...
class EntryExecTranDocomoMiniInput
{
     ...
     */
    private $entryTranDocomoMiniInput;
    /* @var $entryTranInput EntryTranDocomoMiniInput */

    /**
     * @var ExecTranDocomoMiniInput d払い(ミニアプリ)実行入力パラメータ
     */
    private $execTranDocomoMiniInput;
    /* @var $execTranInput ExecTranDocomoMiniInput */
