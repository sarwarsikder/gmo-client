...
/**
 * <b>多通貨クレジット決済（DCC)金額変更　入力パラメータクラス</b>
 *
 ...
 */
class ChangeTranDccInput extends BaseInput {
	...
	private $orderID;
	/**
	 * @var integer 利用金額(金額変更後)
	 */
	private $changeAmount;
	/**
	 * @var integer 税送料(金額変更後)
	 */
	private $changeTax;
	/**
	 * @var string 3DS利用フラグ
