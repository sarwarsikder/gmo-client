 ...
 */
class ExecTranPaypayAccept extends BaseTran
{
     ...
     * 決済実行を実行する
     *
     * @param ExecTranPaypayAcceptInput $input 入力パラメータ
     * @return ExecTranPaypayAcceptOutput $output 出力パラメータ
    ...
    public function exec(&$input)
    {
        ...
        // ExecTranPaypayAcceptOutput作成し、戻す
        return new ExecTranPaypayAcceptOutput($resultMap);
    }
}
