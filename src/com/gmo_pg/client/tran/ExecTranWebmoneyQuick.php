 ...
 */
class ExecTranWebmoneyQuick extends BaseTran
{
     ...
     * クイック決済実行を実行する
     *
     * @param ExecTranWebmoneyQuickInput $input 入力パラメータ
     * @return ExecTranWebmoneyQuickOutput $output 出力パラメータ
    ...
    public function exec(&$input)
    {
        ...
        // ExecTranWebmoneyQuickOutput作成し、戻す
        return new ExecTranWebmoneyQuickOutput($resultMap);
    }
}
