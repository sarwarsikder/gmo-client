 ...
 * @created 2013/06/05
 */
class EntryTranAuContinuance extends BaseTran
{
     ...
     * 取引登録を実行する
     *
     * @param EntryTranAuContinuanceInput $input 入力パラメータ
     * @return EntryTranAuContinuanceOutput $output 出力パラメータ
    ...
    public function exec(&$input)
    {
        ...
        // EntryTranAuContinuanceOutput作成し、戻す
        return new EntryTranAuContinuanceOutput($resultMap);
    }
}
