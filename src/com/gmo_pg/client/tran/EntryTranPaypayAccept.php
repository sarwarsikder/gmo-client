 ...
 */
class EntryTranPaypayAccept extends BaseTran
{
     ...
     * 取引登録を実行する
     *
     * @param EntryTranPaypayAcceptInput $input 入力パラメータ
     * @return EntryTranPaypayAcceptOutput $output 出力パラメータ
    ...
    public function exec(&$input)
    {
        ...
        // EntryTranPaypayAcceptOutput作成し、戻す
        return new EntryTranPaypayAcceptOutput($resultMap);
    }
}
