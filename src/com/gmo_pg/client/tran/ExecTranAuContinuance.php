 ...
 * @created 2013/06/05
 */
class ExecTranAuContinuance extends BaseTran
{
     ...
     * 決済実行を実行する
     *
     * @param ExecTranAuContinuanceInput $input 入力パラメータ
     * @return ExecTranAuContinuanceOutput $output 出力パラメータ
    ...
    public function exec(&$input)
    {
        ...
        // ExecTranAuContinuanceOutput作成し、戻す
        return new ExecTranAuContinuanceOutput($resultMap);
    }
}
