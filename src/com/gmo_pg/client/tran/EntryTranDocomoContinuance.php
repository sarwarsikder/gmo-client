...
use GmoPG\com\gmo_pg\client\output\EntryTranDocomoContinuanceOutput;
 ...
 * @created 2012/08/21
 */
class EntryTranDocomoContinuance extends BaseTran
{
     ...
     * 取引登録を実行する
     *
     * @param EntryTranDocomoContinuanceInput $input 入力パラメータ
     * @return EntryTranDocomoContinuanceOutput $output 出力パラメータ
    ...
    public function exec(&$input)
    {
        ...
        // EntryTranDocomoContinuanceOutput作成し、戻す
        return new EntryTranDocomoContinuanceOutput($resultMap);
    }
}
