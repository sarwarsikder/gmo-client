...
use Kcsl\GmoClient\com\gmo_pg\client\output\EntryTranSbOutput;
 ...
 * @created 2012/10/18
 */
class EntryTranSb extends BaseTran
{
     ...
     * 取引登録を実行する
     *
     * @param EntryTranSbInput $input 入力パラメータ
     * @return EntryTranSbOutput $output 出力パラメータ
    ...
    public function exec(&$input)
    {
        ...
        // EntryTranSbOutput作成し、戻す
        return new EntryTranSbOutput($resultMap);
    }
}
