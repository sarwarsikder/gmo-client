 ...
 */
class EntryTranDcc extends BaseTran
{
     ...
     * 取引登録を実行する
     *
     * @param EntryTranDccInput $input 入力パラメータ
     * @return EntryTranDccOutput $output 出力パラメータ
    ...
    public function exec(&$input)
    {
        ...
        // EntryTranDccOutput作成し、戻す
        return new EntryTranDccOutput($resultMap);
    }
}
