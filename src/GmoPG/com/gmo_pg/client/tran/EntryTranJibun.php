 ...
 * @created 2012/10/31
 */
class EntryTranJibun extends BaseTran {
	 ...
	 * 取引登録を実行する
	 *
	 * @param  EntryTranJibunInput $input  入力パラメータ
	 * @return EntryTranJibunOutput $output 出力パラメータ
	...
	public function exec(&$input) {
        ...
        // EntryTranJibunOutput作成し、戻す
	    return new EntryTranJibunOutput($resultMap);
	}
}
?>
