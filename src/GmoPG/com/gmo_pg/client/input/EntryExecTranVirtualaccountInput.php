...
class EntryExecTranVirtualaccountInput
{
     ...
     */
    private $entryTranVirtualaccountInput;
    /* @var $entryTranInput EntryTranVirtualaccountInput */

    /**
     * @var ExecTranVirtualaccountInput 銀行振込(バーチャル口座)実行入力パラメータ
     */
    private $execTranVirtualaccountInput;
    /* @var $execTranInput ExecTranVirtualaccountInput */
