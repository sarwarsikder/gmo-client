 ...
 */
class ExecTranFamipayInput extends BaseInput {
	...
	public function setInputValues($params) {
		...
		$this->setAuthToken($this->getStringValue($params, 'AuthToken', $this->getAuthToken()));
	...
	public function toString() {
		...
		$str .='&';
		$str .= 'AuthToken=' . $this->encodeStr($this->getAuthToken());
