...
class EntryExecTranLinepayInput {
	...
	public function getBranchName() {
		return $this->execTranLinepayInput->getBranchName();
	}
	/**
	 * 店舗ID取得
	 * @return string 店舗ID
	...
	public function getBranchID() {
		return $this->execTranLinepayInput->getBranchID();
	}
	/**
	 * 決済タイプ取得
	 * @return string 決済タイプ
	...
	public function getPaymentType() {
		return $this->execTranLinepayInput->getPaymentType();
	}
	/**
	 * 決済用RegKey取得
	...
	public function getSettlementRegKey() {
		return $this->execTranLinepayInput->getSettlementRegKey();
	}
	...
	public function setBranchName($branchName) {
		$this->execTranLinepayInput->setBranchName($branchName);
	}
	/**
	 * 店舗ID設定
	 *
	...
	public function setBranchID($branchID) {
		$this->execTranLinepayInput->setBranchID($branchID);
	}
	/**
	 * 決済タイプ設定
	 *
	...
	public function setPaymentType($paymentType) {
		$this->execTranLinepayInput->setPaymentType($paymentType);
	}
	/**
	 * 決済用RegKey設定
	 *
	...
	public function setSettlementRegKey($settlementRegKey) {
		$this->execTranLinepayInput->setSettlementRegKey($settlementRegKey);
	}
