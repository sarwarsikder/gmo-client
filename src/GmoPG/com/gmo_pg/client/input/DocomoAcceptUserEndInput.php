...
/**
 * <b>ドコモ払い_随時決済利用承諾終了　入力パラメータクラス</b>
 *
 ...
 */
class DocomoAcceptUserEndInput extends BaseInput {
	...
	public function setInputValues($params) {
		...
		$this->setDocomoAcceptCode($this->getStringValue($params, 'DocomoAcceptCode', $this->getDocomoAcceptCode()));
	...
	public function toString() {
		...
		$str .='&';
		$str .= 'DocomoAcceptCode=' . $this->encodeStr($this->getDocomoAcceptCode());
