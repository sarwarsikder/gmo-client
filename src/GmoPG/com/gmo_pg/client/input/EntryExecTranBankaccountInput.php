...
class EntryExecTranBankaccountInput
{
     ...
     */
    private $entryTranBankaccountInput;
    /* @var $entryTranInput EntryTranBankaccountInput */

    /**
     * @var ExecTranBankaccountInput 口振セレクト実行入力パラメータ
     */
    private $execTranBankaccountInput;
    /* @var $execTranInput ExecTranBankaccountInput */
