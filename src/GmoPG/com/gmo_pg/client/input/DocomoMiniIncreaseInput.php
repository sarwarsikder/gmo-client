 ...
 */
class DocomoMiniIncreaseInput extends BaseInput {
	...
	public function setInputValues($params) {
		...
		$this->setIncreaseAmount($this->getStringValue($params, 'IncreaseAmount', $this->getIncreaseAmount()));
		$this->setIncreaseTax($this->getStringValue($params, 'IncreaseTax', $this->getIncreaseTax()));
