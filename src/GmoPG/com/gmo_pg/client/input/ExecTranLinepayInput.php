...
class ExecTranLinepayInput extends BaseInput {
	...
	private $paymentType;
	/**
	 * @var string 決済用RegKey
	 */
	private $settlementRegKey;
	 ...
	 */
	public function getSettlementRegKey() {
		return $this->settlementRegKey;
	}
	 ...
	 * 決済用RegKey設定
	 *
	 * @param string $settlementRegKey
	 */
	public function setSettlementRegKey($settlementRegKey) {
		$this->settlementRegKey = $settlementRegKey;
	}
	...
	public function setInputValues($params) {
		...
		$this->setBranchName($this->getStringValue($params, 'BranchName', $this->getBranchName()));
		$this->setBranchID($this->getStringValue($params, 'BranchID', $this->getBranchID()));
		$this->setPaymentType($this->getStringValue($params, 'PaymentType', $this->getPaymentType()));
		$this->setSettlementRegKey($this->getStringValue($params, 'SettlementRegKey', $this->getSettlementRegKey()));
	...
	public function toString() {
		...
		$str .='&';
		$str .= 'BranchID=' . $this->encodeStr($this->getBranchID());
		$str .='&';
		$str .= 'PaymentType=' . $this->encodeStr($this->getPaymentType());
		$str .='&';
		$str .= 'SettlementRegKey=' . $this->encodeStr($this->getSettlementRegKey());
