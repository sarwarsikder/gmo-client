...
class EntryExecTranPaypayAcceptInput {
	 ...
	 */
	private $entryTranPaypayAcceptInput;/* @var $entryTranInput EntryTranPaypayAcceptInput */

	/**
	 * @var ExecTranPaypayAcceptInput PayPay随時(利用承諾)実行入力パラメータ
	 */
	private $execTranPaypayAcceptInput;/* @var $execTranInput ExecTranPaypayAcceptInput */
