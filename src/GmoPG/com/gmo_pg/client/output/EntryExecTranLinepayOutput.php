...
class EntryExecTranLinepayOutput {
	...
	public function getTranDate() {
		return $this->execTranLinepayOutput->getTranDate();

	}
	/**
	 * LINE Pay トランザクションID取得
	 * @return string LINE Pay トランザクションID
	 */
	public function getTranID() {
		return $this->execTranLinepayOutput->getTranID();
	...
	public function setOrderID($orderID) {
		...
		$this->execTranLinepayOutput->setOrderID($orderID);
	...
	public function setTranDate($tranDate) {
		$this->execTranLinepayOutput->setTranDate($tranDate);

	}
	/**
	 * LINE Pay トランザクションID設定
	 *
	 * @param string $tranID
	 */
	public function setTranID($tranID) {
		$this->execTranLinepayOutput->setTranID($tranID);
